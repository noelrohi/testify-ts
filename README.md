...
[`TestifyError`](./src/models/errors/testifyerror.ts) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`TestifyError`](./src/models/errors/testifyerror.ts): The base class for HTTP error responses.
  * [`StandardError`](./src/models/errors/standarderror.ts): Generic error.
...
**Inherit from [`TestifyError`](./src/models/errors/testifyerror.ts)**:
* [`RateLimitError`](./src/models/errors/ratelimiterror.ts): Too Many Requests. Status code `429`. Applicable to 1 of 2 methods.*
