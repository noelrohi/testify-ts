...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/hov/noelrohi). Delete this section before > publishing to a package manager.
...
```bash
npm add https://github.com/noelrohi/testify-ts
```

### PNPM

```bash
pnpm add https://github.com/noelrohi/testify-ts
```

### Bun

```bash
bun add https://github.com/noelrohi/testify-ts
```

### Yarn

```bash
yarn add https://github.com/noelrohi/testify-ts zod
